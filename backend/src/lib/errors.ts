...
export const ErrorCodes = {
  ...
  Orders: {
    ...
    InvalidOptionChoice: 'orders.create.invalid_option_choice',
    DuplicateOptionGroupSelection: 'orders.create.duplicate_option_group_selection',
    MissingRequiredOption: 'orders.create.missing_required_option',
    InvalidSetFrameChoice: 'orders.create.invalid_set_frame_choice',
    MissingSetFrameSelection: 'orders.create.missing_set_frame_selection',
    SetFrameChoiceSoldOut: 'orders.create.set_frame_choice_sold_out',
    SetFrameSelectionNotApplicable: 'orders.create.set_frame_selection_not_applicable',
    ...
    SetChildNotCancellable: 'orders.cancel.set_child_not_cancellable',
  ...
  Menus: {
    ...
    SetWithOptionsNotAllowed: 'menus.save.set_with_options_not_allowed',
    SetFrameChoiceMenuItemNotFound: 'menus.save.set_frame_choice_menu_item_not_found',
  },
  Categories: {
  ...
  Customer: {
    ...
    InvalidOptionChoice: 'customer.orders.invalid_option_choice',
    DuplicateOptionGroupSelection: 'customer.orders.duplicate_option_group_selection',
    MissingRequiredOption: 'customer.orders.missing_required_option',
    InvalidSetFrameChoice: 'customer.orders.invalid_set_frame_choice',
    MissingSetFrameSelection: 'customer.orders.missing_set_frame_selection',
    SetFrameChoiceSoldOut: 'customer.orders.set_frame_choice_sold_out',
    SetFrameSelectionNotApplicable: 'customer.orders.set_frame_selection_not_applicable',
