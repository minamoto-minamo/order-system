...
export const SOCKET_EVENTS = {
  ...
  categoryCreated: s('category:created'),
  categoryUpdated: s('category:updated'),
  categoryDeleted: s('category:deleted'),
  subCategoryCreated: s('subCategory:created'),
  subCategoryUpdated: s('subCategory:updated'),
  subCategoryDeleted: s('subCategory:deleted'),
