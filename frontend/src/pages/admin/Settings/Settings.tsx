    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto p-5 max-w-150 mx-auto w-full">
        ...
        <Section title={t('settings.storeInfo')}>
          <SettingRow label={t('settings.storeName')} sub={t('settings.storeNameSub')}>
            <input
        ...
        <Section title={t('settings.businessSettings')}>
          ...
          <SettingHint>
            <span className="whitespace-pre-line">{t('settings.closingTimeHint')}</span>
          </SettingHint>
        </Section>

        {/* 税率設定 */}
        <Section title={t('settings.taxSettings')}>
          <SettingRow label={t('settings.taxInclusive')} sub={t('settings.taxInclusiveSub')}>
            <ToggleButtonGroup
              options={[
          ...
          <SettingRow label={t('settings.taxDineIn')} sub={t('settings.taxDineInSub')}>
            <div className="flex items-center gap-1.5">
              <input
          ...
          <SettingRow label={t('settings.taxTakeout')} sub={t('settings.taxTakeoutSub')}>
            <div className="flex items-center gap-1.5">
              <input
                className="input-field border border-line rounded-[7px] px-2 py-1.5 text-sm w-15 text-center text-ink"
                type="number"
